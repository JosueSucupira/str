...
void button_task(void *pvParameters) {
    while (1) {
        // Esperar pelo semáforo contador
...
int main(void) {
    ...
    // Criar semáforo contador e fila
    buttonSemaphore = xSemaphoreCreateCounting(SEMAPHORE_MAX_COUNT, 0);  // Inicializado com 0 permissões
